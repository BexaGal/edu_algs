...
x = sympy.symbols('x')
y = x*sympy.log(x, sympy.E) + sympy.sin(x)**2
print(sympy.latex(y), '\n')
y1 = sympy.diff(y,x,1)
...
p.append(sympy.plotting.plot(y2, (x, -10, 10), legend=1, show=False)[0])
p.append(sympy.plotting.plot(y4, (x, -10, 10), legend=1, show=False)[0])
p.show()
